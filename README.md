...
📚 **Full documentation:** <https://nandha-d3v.github.io/d3v-ai-cli/>
...
- **Bundled + remote registry.** `dxai update` refreshes the MCP / skill catalog from a remote URL; bundled JSON is the offline fallback. Override the source with `DXAI_REGISTRY_URL`.
...
Per-command pages with full options tables: [Reference / Commands](https://nandha-d3v.github.io/d3v-ai-cli/reference/commands/).
...
Full flag table: [Reference / Flags](https://nandha-d3v.github.io/d3v-ai-cli/reference/flags/).
...
cd d3v-ai-cli
npm install
npm test                          # 42 tests, ~100ms (node:test, no extra framework)
...
| Page | Source |
|---|---|
| [Registry / MCP servers](https://nandha-d3v.github.io/d3v-ai-cli/registry/mcp-servers/) | `src/registry/data/mcp-servers.json` |
| [Registry / Skills](https://nandha-d3v.github.io/d3v-ai-cli/registry/skills/) | `src/registry/data/skills.json` |
| [Registry / Stacks](https://nandha-d3v.github.io/d3v-ai-cli/registry/stacks/) | `src/registry/stacks.js` (`TECH_STACKS`, `CURSOR_RULES`) |
| [Registry / Cursor commands](https://nandha-d3v.github.io/d3v-ai-cli/registry/cursor-commands/) | `src/registry/stacks.js` (`CURSOR_COMMANDS`) |
| [Reference / Commands](https://nandha-d3v.github.io/d3v-ai-cli/reference/commands/) | `bin/cli.js` (`buildProgram()`) |
| [Reference / Flags](https://nandha-d3v.github.io/d3v-ai-cli/reference/flags/) | `bin/cli.js` (`buildProgram()`) |
| [Reference / Profile schema](https://nandha-d3v.github.io/d3v-ai-cli/reference/profile-schema/) | `src/profile.js` (`PROFILE_KEYS`) |
| [Reference / Manifest schema](https://nandha-d3v.github.io/d3v-ai-cli/reference/manifest-schema/) | `src/manifest.js` (`emptyManifest`) |
| [Changelog](https://nandha-d3v.github.io/d3v-ai-cli/changelog/) | `git log` (conventional commits) |
