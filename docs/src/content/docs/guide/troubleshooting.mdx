...
Most likely: the server needs an env var that isn't set. Run `dxai doctor` to see which env vars are missing, or check the [Registry / MCP servers](/registry/mcp-servers/) page.
