...
npx dxai-cli apply               # auto-loads ./.dxai/profile.json

# List discoverable profiles.
npx dxai-cli profiles
```

For the live schema see [Reference / Profile schema](/reference/profile-schema/).
