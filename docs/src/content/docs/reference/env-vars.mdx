...
Plus any env vars required by the MCP servers you select (e.g. `GITHUB_PERSONAL_ACCESS_TOKEN`, `LINEAR_API_KEY`). See [Registry / MCP servers](/d3v-ai-cli/registry/mcp-servers/) for the per-server list.
