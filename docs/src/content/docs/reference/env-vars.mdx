...
| `DXAI_MCP_REGISTRY_URL` | Override the official MCP Registry base URL (default `https://registry.modelcontextprotocol.io`) used by `dxai update` and `dxai add <registry-name>`. |
