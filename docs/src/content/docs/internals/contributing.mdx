...
- Read the [Maintainer Notes](/dxai/internals/development/) — dev loop, invariants (idempotent writes, backups, manifest recording, untrusted-registry validation, honest exit codes), and the data-vs-code release tracks.
